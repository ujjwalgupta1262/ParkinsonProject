...
def get_female(list, label):
    index_pd = [0,1,2,3,4,5,6,7,12,14,15,16,17,18,19,22,26,35]; #for task1
    index_hc = [0,2,3,6,11,12,15,16,18,19,22,25,26,27,30,31,34]; #for task1
...
accuracy_list = []
passed_vec = open("female_passed_t1.txt", "r").readlines()
...
file = open("female_accuracy_t1_new.txt", "w")
