...
trimMean_strokespeed_pd=importdata("trimMean_strokespeed_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_strokespeed_pd=importdata("percentiles_strokespeed_hc.txt","\n",5).data(female_pd_ind,:);
moments_strokespeed_pd=importdata("moments_strokespeed_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_vel_on_pd=importdata("trimMean_vel_on_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_vel_on_pd=importdata("percentiles_vel_on_hc.txt","\n",5).data(female_pd_ind,:);
moments_vel_on_pd=importdata("moments_vel_on_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_acc_on_pd=importdata("trimMean_acc_on_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_acc_on_pd=importdata("percentiles_acc_on_hc.txt","\n",5).data(female_pd_ind,:);
moments_acc_on_pd=importdata("moments_acc_on_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_jerk_on_pd=importdata("trimMean_jerk_on_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_jerk_on_pd=importdata("percentiles_jerk_on_hc.txt","\n",5).data(female_pd_ind,:);
moments_jerk_on_pd=importdata("moments_jerk_on_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_x_vel_on_pd=importdata("trimMean_x_vel_on_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_x_vel_on_pd=importdata("percentiles_x_vel_on_hc.txt","\n",5).data(female_pd_ind,:);
moments_x_vel_on_pd=importdata("moments_x_vel_on_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_x_acc_on_pd=importdata("trimMean_x_acc_on_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_x_acc_on_pd=importdata("percentiles_x_acc_on_hc.txt","\n",5).data(female_pd_ind,:);
moments_x_acc_on_pd=importdata("moments_x_acc_on_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_x_jerk_on_pd=importdata("trimMean_x_jerk_on_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_x_jerk_on_pd=importdata("percentiles_x_jerk_on_hc.txt","\n",5).data(female_pd_ind,:);
moments_x_jerk_on_pd=importdata("moments_x_jerk_on_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_y_vel_on_pd=importdata("trimMean_y_vel_on_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_y_vel_on_pd=importdata("percentiles_y_vel_on_hc.txt","\n",5).data(female_pd_ind,:);
moments_y_vel_on_pd=importdata("moments_y_vel_on_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_y_acc_on_pd=importdata("trimMean_y_acc_on_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_y_acc_on_pd=importdata("percentiles_y_acc_on_hc.txt","\n",5).data(female_pd_ind,:);
moments_y_acc_on_pd=importdata("moments_y_acc_on_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_y_jerk_on_pd=importdata("trimMean_y_jerk_on_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_y_jerk_on_pd=importdata("percentiles_y_jerk_on_hc.txt","\n",5).data(female_pd_ind,:);
moments_y_jerk_on_pd=importdata("moments_y_jerk_on_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_vel_off_pd=importdata("trimMean_vel_off_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_vel_off_pd=importdata("percentiles_vel_off_hc.txt","\n",5).data(female_pd_ind,:);
moments_vel_off_pd=importdata("moments_vel_off_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_acc_off_pd=importdata("trimMean_acc_off_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_acc_off_pd=importdata("percentiles_acc_off_hc.txt","\n",5).data(female_pd_ind,:);
moments_acc_off_pd=importdata("moments_acc_off_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_jerk_off_pd=importdata("trimMean_jerk_off_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_jerk_off_pd=importdata("percentiles_jerk_off_hc.txt","\n",5).data(female_pd_ind,:);
moments_jerk_off_pd=importdata("moments_jerk_off_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_x_vel_off_pd=importdata("trimMean_x_vel_off_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_x_vel_off_pd=importdata("percentiles_x_vel_off_hc.txt","\n",5).data(female_pd_ind,:);
moments_x_vel_off_pd=importdata("moments_x_vel_off_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_x_acc_off_pd=importdata("trimMean_x_acc_off_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_x_acc_off_pd=importdata("percentiles_x_acc_off_hc.txt","\n",5).data(female_pd_ind,:);
moments_x_acc_off_pd=importdata("moments_x_acc_off_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_x_jerk_off_pd=importdata("trimMean_x_jerk_off_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_x_jerk_off_pd=importdata("percentiles_x_jerk_off_hc.txt","\n",5).data(female_pd_ind,:);
moments_x_jerk_off_pd=importdata("moments_x_jerk_off_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_y_vel_off_pd=importdata("trimMean_y_vel_off_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_y_vel_off_pd=importdata("percentiles_y_vel_off_hc.txt","\n",5).data(female_pd_ind,:);
moments_y_vel_off_pd=importdata("moments_y_vel_off_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_y_acc_off_pd=importdata("trimMean_y_acc_off_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_y_acc_off_pd=importdata("percentiles_y_acc_off_hc.txt","\n",5).data(female_pd_ind,:);
moments_y_acc_off_pd=importdata("moments_y_acc_off_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_y_jerk_off_pd=importdata("trimMean_y_jerk_off_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_y_jerk_off_pd=importdata("percentiles_y_jerk_off_hc.txt","\n",5).data(female_pd_ind,:);
moments_y_jerk_off_pd=importdata("moments_y_jerk_off_hc.txt","\n",5).data(female_pd_ind,:);
...
trimMean_pressure_rate_pd=importdata("trimMean_pressure_rate_hc.txt","\n",5).data(female_pd_ind,:);
percentiles_pressure_rate_pd=importdata("percentiles_pressure_rate_hc.txt","\n",5).data(female_pd_ind,:);
moments_pressure_rate_pd=importdata("moments_pressure_rate_hc.txt","\n",5).data(female_pd_ind,:);
