male_hc_ind = [2,5,6,8,9,10,11,14,15,19,22,23,25,26,30,31,32,35,36];
...
speed_pd=importdata("speed_hc.txt","\n",5).data(male_pd_ind);
NCV_on_pd=importdata("NCV_on_hc.txt","\n",5).data(male_pd_ind);
NCA_on_pd=importdata("NCA_on_hc.txt","\n",5).data(male_pd_ind);
rel_NCV_on_pd=importdata("rel_NCV_on_hc.txt","\n",5).data(male_pd_ind);
rel_NCA_on_pd=importdata("rel_NCA_on_hc.txt","\n",5).data(male_pd_ind);
norm_onTime_pd=importdata("norm_onTime_hc.txt","\n",5).data(male_pd_ind);
norm_offTime_pd=importdata("norm_offTime_hc.txt","\n",5).data(male_pd_ind);
NCP_pd=importdata("NCP_hc.txt","\n",5).data(male_pd_ind);
rel_NCP_pd=importdata("rel_NCP_hc.txt","\n",5).data(male_pd_ind);
NCV_off_pd=importdata("NCV_off_hc.txt","\n",5).data(male_pd_ind);
NCA_off_pd=importdata("NCA_off_hc.txt","\n",5).data(male_pd_ind);
rel_NCV_off_pd=importdata("rel_NCV_off_hc.txt","\n",5).data(male_pd_ind);
rel_NCA_off_pd=importdata("rel_NCA_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_strokespeed_pd=importdata("arithMean_strokespeed_hc.txt","\n",5).data(male_pd_ind);
geoMean_strokespeed_pd=importdata("geoMean_strokespeed_hc.txt","\n",5).data(male_pd_ind);
trimMean_strokespeed_pd=importdata("trimMean_strokespeed_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_strokespeed_pd=importdata("percentiles_strokespeed_hc.txt"," ",5).data(male_hc_ind,:);
moments_strokespeed_pd=importdata("moments_strokespeed_hc.txt"," ",5).data(male_hc_ind,:);
kurto_strokespeed_pd=importdata("kurto_strokespeed_hc.txt","\n",5).data(male_pd_ind);
ranges_strokespeed_pd=importdata("ranges_strokespeed_hc.txt","\n",5).data(male_pd_ind);
medians_strokespeed_pd=importdata("medians_strokespeed_hc.txt","\n",5).data(male_pd_ind);
modes_strokespeed_pd=importdata("modes_strokespeed_hc.txt","\n",5).data(male_pd_ind);
stdDevs_strokespeed_pd=importdata("stdDevs_strokespeed_hc.txt","\n",5).data(male_pd_ind);
robustRange_strokespeed_pd=importdata("robustRange_strokespeed_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_strokespeed_pd=importdata("interQuartiles_strokespeed_hc.txt","\n",5).data(male_pd_ind);

arithMean_vel_on_pd=importdata("arithMean_vel_on_hc.txt","\n",5).data(male_pd_ind);
geoMean_vel_on_pd=importdata("geoMean_vel_on_hc.txt","\n",5).data(male_pd_ind);
trimMean_vel_on_pd=importdata("trimMean_vel_on_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_vel_on_pd=importdata("percentiles_vel_on_hc.txt"," ",5).data(male_hc_ind,:);
moments_vel_on_pd=importdata("moments_vel_on_hc.txt"," ",5).data(male_hc_ind,:);
kurto_vel_on_pd=importdata("kurto_vel_on_hc.txt","\n",5).data(male_pd_ind);
ranges_vel_on_pd=importdata("ranges_vel_on_hc.txt","\n",5).data(male_pd_ind);
medians_vel_on_pd=importdata("medians_vel_on_hc.txt","\n",5).data(male_pd_ind);
modes_vel_on_pd=importdata("modes_vel_on_hc.txt","\n",5).data(male_pd_ind);
stdDevs_vel_on_pd=importdata("stdDevs_vel_on_hc.txt","\n",5).data(male_pd_ind);
robustRange_vel_on_pd=importdata("robustRange_vel_on_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_vel_on_pd=importdata("interQuartiles_vel_on_hc.txt","\n",5).data(male_pd_ind);

arithMean_acc_on_pd=importdata("arithMean_acc_on_hc.txt","\n",5).data(male_pd_ind);
geoMean_acc_on_pd=importdata("geoMean_acc_on_hc.txt","\n",5).data(male_pd_ind);
trimMean_acc_on_pd=importdata("trimMean_acc_on_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_acc_on_pd=importdata("percentiles_acc_on_hc.txt"," ",5).data(male_hc_ind,:);
moments_acc_on_pd=importdata("moments_acc_on_hc.txt"," ",5).data(male_hc_ind,:);
kurto_acc_on_pd=importdata("kurto_acc_on_hc.txt","\n",5).data(male_pd_ind);
ranges_acc_on_pd=importdata("ranges_acc_on_hc.txt","\n",5).data(male_pd_ind);
medians_acc_on_pd=importdata("medians_acc_on_hc.txt","\n",5).data(male_pd_ind);
modes_acc_on_pd=importdata("modes_acc_on_hc.txt","\n",5).data(male_pd_ind);
stdDevs_acc_on_pd=importdata("stdDevs_acc_on_hc.txt","\n",5).data(male_pd_ind);
robustRange_acc_on_pd=importdata("robustRange_acc_on_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_acc_on_pd=importdata("interQuartiles_acc_on_hc.txt","\n",5).data(male_pd_ind);

arithMean_jerk_on_pd=importdata("arithMean_jerk_on_hc.txt","\n",5).data(male_pd_ind);
geoMean_jerk_on_pd=importdata("geoMean_jerk_on_hc.txt","\n",5).data(male_pd_ind);
trimMean_jerk_on_pd=importdata("trimMean_jerk_on_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_jerk_on_pd=importdata("percentiles_jerk_on_hc.txt"," ",5).data(male_hc_ind,:);
moments_jerk_on_pd=importdata("moments_jerk_on_hc.txt"," ",5).data(male_hc_ind,:);
kurto_jerk_on_pd=importdata("kurto_jerk_on_hc.txt","\n",5).data(male_pd_ind);
ranges_jerk_on_pd=importdata("ranges_jerk_on_hc.txt","\n",5).data(male_pd_ind);
medians_jerk_on_pd=importdata("medians_jerk_on_hc.txt","\n",5).data(male_pd_ind);
modes_jerk_on_pd=importdata("modes_jerk_on_hc.txt","\n",5).data(male_pd_ind);
stdDevs_jerk_on_pd=importdata("stdDevs_jerk_on_hc.txt","\n",5).data(male_pd_ind);
robustRange_jerk_on_pd=importdata("robustRange_jerk_on_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_jerk_on_pd=importdata("interQuartiles_jerk_on_hc.txt","\n",5).data(male_pd_ind);

arithMean_x_vel_on_pd=importdata("arithMean_x_vel_on_hc.txt","\n",5).data(male_pd_ind);
geoMean_x_vel_on_pd=importdata("geoMean_x_vel_on_hc.txt","\n",5).data(male_pd_ind);
trimMean_x_vel_on_pd=importdata("trimMean_x_vel_on_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_x_vel_on_pd=importdata("percentiles_x_vel_on_hc.txt"," ",5).data(male_hc_ind,:);
moments_x_vel_on_pd=importdata("moments_x_vel_on_hc.txt"," ",5).data(male_hc_ind,:);
kurto_x_vel_on_pd=importdata("kurto_x_vel_on_hc.txt","\n",5).data(male_pd_ind);
ranges_x_vel_on_pd=importdata("ranges_x_vel_on_hc.txt","\n",5).data(male_pd_ind);
medians_x_vel_on_pd=importdata("medians_x_vel_on_hc.txt","\n",5).data(male_pd_ind);
modes_x_vel_on_pd=importdata("modes_x_vel_on_hc.txt","\n",5).data(male_pd_ind);
stdDevs_x_vel_on_pd=importdata("stdDevs_x_vel_on_hc.txt","\n",5).data(male_pd_ind);
robustRange_x_vel_on_pd=importdata("robustRange_x_vel_on_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_x_vel_on_pd=importdata("interQuartiles_x_vel_on_hc.txt","\n",5).data(male_pd_ind);

arithMean_x_acc_on_pd=importdata("arithMean_x_acc_on_hc.txt","\n",5).data(male_pd_ind);
geoMean_x_acc_on_pd=importdata("geoMean_x_acc_on_hc.txt","\n",5).data(male_pd_ind);
trimMean_x_acc_on_pd=importdata("trimMean_x_acc_on_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_x_acc_on_pd=importdata("percentiles_x_acc_on_hc.txt"," ",5).data(male_hc_ind,:);
moments_x_acc_on_pd=importdata("moments_x_acc_on_hc.txt"," ",5).data(male_hc_ind,:);
kurto_x_acc_on_pd=importdata("kurto_x_acc_on_hc.txt","\n",5).data(male_pd_ind);
ranges_x_acc_on_pd=importdata("ranges_x_acc_on_hc.txt","\n",5).data(male_pd_ind);
medians_x_acc_on_pd=importdata("medians_x_acc_on_hc.txt","\n",5).data(male_pd_ind);
modes_x_acc_on_pd=importdata("modes_x_acc_on_hc.txt","\n",5).data(male_pd_ind);
stdDevs_x_acc_on_pd=importdata("stdDevs_x_acc_on_hc.txt","\n",5).data(male_pd_ind);
robustRange_x_acc_on_pd=importdata("robustRange_x_acc_on_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_x_acc_on_pd=importdata("interQuartiles_x_acc_on_hc.txt","\n",5).data(male_pd_ind);

arithMean_x_jerk_on_pd=importdata("arithMean_x_jerk_on_hc.txt","\n",5).data(male_pd_ind);
geoMean_x_jerk_on_pd=importdata("geoMean_x_jerk_on_hc.txt","\n",5).data(male_pd_ind);
trimMean_x_jerk_on_pd=importdata("trimMean_x_jerk_on_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_x_jerk_on_pd=importdata("percentiles_x_jerk_on_hc.txt"," ",5).data(male_hc_ind,:);
moments_x_jerk_on_pd=importdata("moments_x_jerk_on_hc.txt"," ",5).data(male_hc_ind,:);
kurto_x_jerk_on_pd=importdata("kurto_x_jerk_on_hc.txt","\n",5).data(male_pd_ind);
ranges_x_jerk_on_pd=importdata("ranges_x_jerk_on_hc.txt","\n",5).data(male_pd_ind);
medians_x_jerk_on_pd=importdata("medians_x_jerk_on_hc.txt","\n",5).data(male_pd_ind);
modes_x_jerk_on_pd=importdata("modes_x_jerk_on_hc.txt","\n",5).data(male_pd_ind);
stdDevs_x_jerk_on_pd=importdata("stdDevs_x_jerk_on_hc.txt","\n",5).data(male_pd_ind);
robustRange_x_jerk_on_pd=importdata("robustRange_x_jerk_on_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_x_jerk_on_pd=importdata("interQuartiles_x_jerk_on_hc.txt","\n",5).data(male_pd_ind);

arithMean_y_vel_on_pd=importdata("arithMean_y_vel_on_hc.txt","\n",5).data(male_pd_ind);
geoMean_y_vel_on_pd=importdata("geoMean_y_vel_on_hc.txt","\n",5).data(male_pd_ind);
trimMean_y_vel_on_pd=importdata("trimMean_y_vel_on_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_y_vel_on_pd=importdata("percentiles_y_vel_on_hc.txt"," ",5).data(male_hc_ind,:);
moments_y_vel_on_pd=importdata("moments_y_vel_on_hc.txt"," ",5).data(male_hc_ind,:);
kurto_y_vel_on_pd=importdata("kurto_y_vel_on_hc.txt","\n",5).data(male_pd_ind);
ranges_y_vel_on_pd=importdata("ranges_y_vel_on_hc.txt","\n",5).data(male_pd_ind);
medians_y_vel_on_pd=importdata("medians_y_vel_on_hc.txt","\n",5).data(male_pd_ind);
modes_y_vel_on_pd=importdata("modes_y_vel_on_hc.txt","\n",5).data(male_pd_ind);
stdDevs_y_vel_on_pd=importdata("stdDevs_y_vel_on_hc.txt","\n",5).data(male_pd_ind);
robustRange_y_vel_on_pd=importdata("robustRange_y_vel_on_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_y_vel_on_pd=importdata("interQuartiles_y_vel_on_hc.txt","\n",5).data(male_pd_ind);

arithMean_y_acc_on_pd=importdata("arithMean_y_acc_on_hc.txt","\n",5).data(male_pd_ind);
geoMean_y_acc_on_pd=importdata("geoMean_y_acc_on_hc.txt","\n",5).data(male_pd_ind);
trimMean_y_acc_on_pd=importdata("trimMean_y_acc_on_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_y_acc_on_pd=importdata("percentiles_y_acc_on_hc.txt"," ",5).data(male_hc_ind,:);
moments_y_acc_on_pd=importdata("moments_y_acc_on_hc.txt"," ",5).data(male_hc_ind,:);
kurto_y_acc_on_pd=importdata("kurto_y_acc_on_hc.txt","\n",5).data(male_pd_ind);
ranges_y_acc_on_pd=importdata("ranges_y_acc_on_hc.txt","\n",5).data(male_pd_ind);
medians_y_acc_on_pd=importdata("medians_y_acc_on_hc.txt","\n",5).data(male_pd_ind);
modes_y_acc_on_pd=importdata("modes_y_acc_on_hc.txt","\n",5).data(male_pd_ind);
stdDevs_y_acc_on_pd=importdata("stdDevs_y_acc_on_hc.txt","\n",5).data(male_pd_ind);
robustRange_y_acc_on_pd=importdata("robustRange_y_acc_on_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_y_acc_on_pd=importdata("interQuartiles_y_acc_on_hc.txt","\n",5).data(male_pd_ind);

arithMean_y_jerk_on_pd=importdata("arithMean_y_jerk_on_hc.txt","\n",5).data(male_pd_ind);
geoMean_y_jerk_on_pd=importdata("geoMean_y_jerk_on_hc.txt","\n",5).data(male_pd_ind);
trimMean_y_jerk_on_pd=importdata("trimMean_y_jerk_on_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_y_jerk_on_pd=importdata("percentiles_y_jerk_on_hc.txt"," ",5).data(male_hc_ind,:);
moments_y_jerk_on_pd=importdata("moments_y_jerk_on_hc.txt"," ",5).data(male_hc_ind,:);
kurto_y_jerk_on_pd=importdata("kurto_y_jerk_on_hc.txt","\n",5).data(male_pd_ind);
ranges_y_jerk_on_pd=importdata("ranges_y_jerk_on_hc.txt","\n",5).data(male_pd_ind);
medians_y_jerk_on_pd=importdata("medians_y_jerk_on_hc.txt","\n",5).data(male_pd_ind);
modes_y_jerk_on_pd=importdata("modes_y_jerk_on_hc.txt","\n",5).data(male_pd_ind);
stdDevs_y_jerk_on_pd=importdata("stdDevs_y_jerk_on_hc.txt","\n",5).data(male_pd_ind);
robustRange_y_jerk_on_pd=importdata("robustRange_y_jerk_on_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_y_jerk_on_pd=importdata("interQuartiles_y_jerk_on_hc.txt","\n",5).data(male_pd_ind);

arithMean_vel_off_pd=importdata("arithMean_vel_off_hc.txt","\n",5).data(male_pd_ind);
geoMean_vel_off_pd=importdata("geoMean_vel_off_hc.txt","\n",5).data(male_pd_ind);
trimMean_vel_off_pd=importdata("trimMean_vel_off_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_vel_off_pd=importdata("percentiles_vel_off_hc.txt"," ",5).data(male_hc_ind,:);
moments_vel_off_pd=importdata("moments_vel_off_hc.txt"," ",5).data(male_hc_ind,:);
kurto_vel_off_pd=importdata("kurto_vel_off_hc.txt","\n",5).data(male_pd_ind);
ranges_vel_off_pd=importdata("ranges_vel_off_hc.txt","\n",5).data(male_pd_ind);
medians_vel_off_pd=importdata("medians_vel_off_hc.txt","\n",5).data(male_pd_ind);
modes_vel_off_pd=importdata("modes_vel_off_hc.txt","\n",5).data(male_pd_ind);
stdDevs_vel_off_pd=importdata("stdDevs_vel_off_hc.txt","\n",5).data(male_pd_ind);
robustRange_vel_off_pd=importdata("robustRange_vel_off_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_vel_off_pd=importdata("interQuartiles_vel_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_acc_off_pd=importdata("arithMean_acc_off_hc.txt","\n",5).data(male_pd_ind);
geoMean_acc_off_pd=importdata("geoMean_acc_off_hc.txt","\n",5).data(male_pd_ind);
trimMean_acc_off_pd=importdata("trimMean_acc_off_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_acc_off_pd=importdata("percentiles_acc_off_hc.txt"," ",5).data(male_hc_ind,:);
moments_acc_off_pd=importdata("moments_acc_off_hc.txt"," ",5).data(male_hc_ind,:);
kurto_acc_off_pd=importdata("kurto_acc_off_hc.txt","\n",5).data(male_pd_ind);
ranges_acc_off_pd=importdata("ranges_acc_off_hc.txt","\n",5).data(male_pd_ind);
medians_acc_off_pd=importdata("medians_acc_off_hc.txt","\n",5).data(male_pd_ind);
modes_acc_off_pd=importdata("modes_acc_off_hc.txt","\n",5).data(male_pd_ind);
stdDevs_acc_off_pd=importdata("stdDevs_acc_off_hc.txt","\n",5).data(male_pd_ind);
robustRange_acc_off_pd=importdata("robustRange_acc_off_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_acc_off_pd=importdata("interQuartiles_acc_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_jerk_off_pd=importdata("arithMean_jerk_off_hc.txt","\n",5).data(male_pd_ind);
geoMean_jerk_off_pd=importdata("geoMean_jerk_off_hc.txt","\n",5).data(male_pd_ind);
trimMean_jerk_off_pd=importdata("trimMean_jerk_off_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_jerk_off_pd=importdata("percentiles_jerk_off_hc.txt"," ",5).data(male_hc_ind,:);
moments_jerk_off_pd=importdata("moments_jerk_off_hc.txt"," ",5).data(male_hc_ind,:);
kurto_jerk_off_pd=importdata("kurto_jerk_off_hc.txt","\n",5).data(male_pd_ind);
ranges_jerk_off_pd=importdata("ranges_jerk_off_hc.txt","\n",5).data(male_pd_ind);
medians_jerk_off_pd=importdata("medians_jerk_off_hc.txt","\n",5).data(male_pd_ind);
modes_jerk_off_pd=importdata("modes_jerk_off_hc.txt","\n",5).data(male_pd_ind);
stdDevs_jerk_off_pd=importdata("stdDevs_jerk_off_hc.txt","\n",5).data(male_pd_ind);
robustRange_jerk_off_pd=importdata("robustRange_jerk_off_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_jerk_off_pd=importdata("interQuartiles_jerk_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_x_vel_off_pd=importdata("arithMean_x_vel_off_hc.txt","\n",5).data(male_pd_ind);
geoMean_x_vel_off_pd=importdata("geoMean_x_vel_off_hc.txt","\n",5).data(male_pd_ind);
trimMean_x_vel_off_pd=importdata("trimMean_x_vel_off_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_x_vel_off_pd=importdata("percentiles_x_vel_off_hc.txt"," ",5).data(male_hc_ind,:);
moments_x_vel_off_pd=importdata("moments_x_vel_off_hc.txt"," ",5).data(male_hc_ind,:);
kurto_x_vel_off_pd=importdata("kurto_x_vel_off_hc.txt","\n",5).data(male_pd_ind);
ranges_x_vel_off_pd=importdata("ranges_x_vel_off_hc.txt","\n",5).data(male_pd_ind);
medians_x_vel_off_pd=importdata("medians_x_vel_off_hc.txt","\n",5).data(male_pd_ind);
modes_x_vel_off_pd=importdata("modes_x_vel_off_hc.txt","\n",5).data(male_pd_ind);
stdDevs_x_vel_off_pd=importdata("stdDevs_x_vel_off_hc.txt","\n",5).data(male_pd_ind);
robustRange_x_vel_off_pd=importdata("robustRange_x_vel_off_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_x_vel_off_pd=importdata("interQuartiles_x_vel_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_x_acc_off_pd=importdata("arithMean_x_acc_off_hc.txt","\n",5).data(male_pd_ind);
geoMean_x_acc_off_pd=importdata("geoMean_x_acc_off_hc.txt","\n",5).data(male_pd_ind);
trimMean_x_acc_off_pd=importdata("trimMean_x_acc_off_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_x_acc_off_pd=importdata("percentiles_x_acc_off_hc.txt"," ",5).data(male_hc_ind,:);
moments_x_acc_off_pd=importdata("moments_x_acc_off_hc.txt"," ",5).data(male_hc_ind,:);
kurto_x_acc_off_pd=importdata("kurto_x_acc_off_hc.txt","\n",5).data(male_pd_ind);
ranges_x_acc_off_pd=importdata("ranges_x_acc_off_hc.txt","\n",5).data(male_pd_ind);
medians_x_acc_off_pd=importdata("medians_x_acc_off_hc.txt","\n",5).data(male_pd_ind);
modes_x_acc_off_pd=importdata("modes_x_acc_off_hc.txt","\n",5).data(male_pd_ind);
stdDevs_x_acc_off_pd=importdata("stdDevs_x_acc_off_hc.txt","\n",5).data(male_pd_ind);
robustRange_x_acc_off_pd=importdata("robustRange_x_acc_off_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_x_acc_off_pd=importdata("interQuartiles_x_acc_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_x_jerk_off_pd=importdata("arithMean_x_jerk_off_hc.txt","\n",5).data(male_pd_ind);
geoMean_x_jerk_off_pd=importdata("geoMean_x_jerk_off_hc.txt","\n",5).data(male_pd_ind);
trimMean_x_jerk_off_pd=importdata("trimMean_x_jerk_off_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_x_jerk_off_pd=importdata("percentiles_x_jerk_off_hc.txt"," ",5).data(male_hc_ind,:);
moments_x_jerk_off_pd=importdata("moments_x_jerk_off_hc.txt"," ",5).data(male_hc_ind,:);
kurto_x_jerk_off_pd=importdata("kurto_x_jerk_off_hc.txt","\n",5).data(male_pd_ind);
ranges_x_jerk_off_pd=importdata("ranges_x_jerk_off_hc.txt","\n",5).data(male_pd_ind);
medians_x_jerk_off_pd=importdata("medians_x_jerk_off_hc.txt","\n",5).data(male_pd_ind);
modes_x_jerk_off_pd=importdata("modes_x_jerk_off_hc.txt","\n",5).data(male_pd_ind);
stdDevs_x_jerk_off_pd=importdata("stdDevs_x_jerk_off_hc.txt","\n",5).data(male_pd_ind);
robustRange_x_jerk_off_pd=importdata("robustRange_x_jerk_off_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_x_jerk_off_pd=importdata("interQuartiles_x_jerk_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_y_vel_off_pd=importdata("arithMean_y_vel_off_hc.txt","\n",5).data(male_pd_ind);
geoMean_y_vel_off_pd=importdata("geoMean_y_vel_off_hc.txt","\n",5).data(male_pd_ind);
trimMean_y_vel_off_pd=importdata("trimMean_y_vel_off_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_y_vel_off_pd=importdata("percentiles_y_vel_off_hc.txt"," ",5).data(male_hc_ind,:);
moments_y_vel_off_pd=importdata("moments_y_vel_off_hc.txt"," ",5).data(male_hc_ind,:);
kurto_y_vel_off_pd=importdata("kurto_y_vel_off_hc.txt","\n",5).data(male_pd_ind);
ranges_y_vel_off_pd=importdata("ranges_y_vel_off_hc.txt","\n",5).data(male_pd_ind);
medians_y_vel_off_pd=importdata("medians_y_vel_off_hc.txt","\n",5).data(male_pd_ind);
modes_y_vel_off_pd=importdata("modes_y_vel_off_hc.txt","\n",5).data(male_pd_ind);
stdDevs_y_vel_off_pd=importdata("stdDevs_y_vel_off_hc.txt","\n",5).data(male_pd_ind);
robustRange_y_vel_off_pd=importdata("robustRange_y_vel_off_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_y_vel_off_pd=importdata("interQuartiles_y_vel_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_y_acc_off_pd=importdata("arithMean_y_acc_off_hc.txt","\n",5).data(male_pd_ind);
geoMean_y_acc_off_pd=importdata("geoMean_y_acc_off_hc.txt","\n",5).data(male_pd_ind);
trimMean_y_acc_off_pd=importdata("trimMean_y_acc_off_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_y_acc_off_pd=importdata("percentiles_y_acc_off_hc.txt"," ",5).data(male_hc_ind,:);
moments_y_acc_off_pd=importdata("moments_y_acc_off_hc.txt"," ",5).data(male_hc_ind,:);
kurto_y_acc_off_pd=importdata("kurto_y_acc_off_hc.txt","\n",5).data(male_pd_ind);
ranges_y_acc_off_pd=importdata("ranges_y_acc_off_hc.txt","\n",5).data(male_pd_ind);
medians_y_acc_off_pd=importdata("medians_y_acc_off_hc.txt","\n",5).data(male_pd_ind);
modes_y_acc_off_pd=importdata("modes_y_acc_off_hc.txt","\n",5).data(male_pd_ind);
stdDevs_y_acc_off_pd=importdata("stdDevs_y_acc_off_hc.txt","\n",5).data(male_pd_ind);
robustRange_y_acc_off_pd=importdata("robustRange_y_acc_off_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_y_acc_off_pd=importdata("interQuartiles_y_acc_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_y_jerk_off_pd=importdata("arithMean_y_jerk_off_hc.txt","\n",5).data(male_pd_ind);
geoMean_y_jerk_off_pd=importdata("geoMean_y_jerk_off_hc.txt","\n",5).data(male_pd_ind);
trimMean_y_jerk_off_pd=importdata("trimMean_y_jerk_off_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_y_jerk_off_pd=importdata("percentiles_y_jerk_off_hc.txt"," ",5).data(male_hc_ind,:);
moments_y_jerk_off_pd=importdata("moments_y_jerk_off_hc.txt"," ",5).data(male_hc_ind,:);
kurto_y_jerk_off_pd=importdata("kurto_y_jerk_off_hc.txt","\n",5).data(male_pd_ind);
ranges_y_jerk_off_pd=importdata("ranges_y_jerk_off_hc.txt","\n",5).data(male_pd_ind);
medians_y_jerk_off_pd=importdata("medians_y_jerk_off_hc.txt","\n",5).data(male_pd_ind);
modes_y_jerk_off_pd=importdata("modes_y_jerk_off_hc.txt","\n",5).data(male_pd_ind);
stdDevs_y_jerk_off_pd=importdata("stdDevs_y_jerk_off_hc.txt","\n",5).data(male_pd_ind);
robustRange_y_jerk_off_pd=importdata("robustRange_y_jerk_off_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_y_jerk_off_pd=importdata("interQuartiles_y_jerk_off_hc.txt","\n",5).data(male_pd_ind);

arithMean_pressure_rate_pd=importdata("arithMean_pressure_rate_hc.txt","\n",5).data(male_pd_ind);
geoMean_pressure_rate_pd=importdata("geoMean_pressure_rate_hc.txt","\n",5).data(male_pd_ind);
trimMean_pressure_rate_pd=importdata("trimMean_pressure_rate_hc.txt"," ",5).data(male_hc_ind,:);
percentiles_pressure_rate_pd=importdata("percentiles_pressure_rate_hc.txt"," ",5).data(male_hc_ind,:);
moments_pressure_rate_pd=importdata("moments_pressure_rate_hc.txt"," ",5).data(male_hc_ind,:);
kurto_pressure_rate_pd=importdata("kurto_pressure_rate_hc.txt","\n",5).data(male_pd_ind);
ranges_pressure_rate_pd=importdata("ranges_pressure_rate_hc.txt","\n",5).data(male_pd_ind);
medians_pressure_rate_pd=importdata("medians_pressure_rate_hc.txt","\n",5).data(male_pd_ind);
modes_pressure_rate_pd=importdata("modes_pressure_rate_hc.txt","\n",5).data(male_pd_ind);
stdDevs_pressure_rate_pd=importdata("stdDevs_pressure_rate_hc.txt","\n",5).data(male_pd_ind);
robustRange_pressure_rate_pd=importdata("robustRange_pressure_rate_hc.txt","\n",5).data(male_pd_ind);
interQuartiles_pressure_rate_pd=importdata("interQuartiles_pressure_rate_hc.txt","\n",5).data(male_pd_ind);

x_shannon_pd=importdata("x_shannon_hc.txt","\n",5).data(male_pd_ind);
y_shannon_pd=importdata("y_shannon_hc.txt","\n",5).data(male_pd_ind);
x_renyi2_pd=importdata("x_renyi2_hc.txt","\n",5).data(male_pd_ind);
y_renyi2_pd=importdata("y_renyi2_hc.txt","\n",5).data(male_pd_ind);
x_renyi3_pd=importdata("x_renyi3_hc.txt","\n",5).data(male_pd_ind);
y_renyi3_pd=importdata("y_renyi3_hc.txt","\n",5).data(male_pd_ind);
snr_ce_x_pd=importdata("snr_ce_x_hc.txt","\n",5).data(male_pd_ind);
snr_ce_y_pd=importdata("snr_ce_y_hc.txt","\n",5).data(male_pd_ind);
snr_tke1_x_pd=importdata("snr_tke1_x_hc.txt","\n",5).data(male_pd_ind);
snr_tke1_y_pd=importdata("snr_tke1_y_hc.txt","\n",5).data(male_pd_ind);
snr_tke2_x_pd=importdata("snr_tke2_x_hc.txt","\n",5).data(male_pd_ind);
snr_tke2_y_pd=importdata("snr_tke2_y_hc.txt","\n",5).data(male_pd_ind);
x_shannon_i1_pd=importdata("x_shannon_i1_hc.txt","\n",5).data(male_pd_ind);
y_shannon_i1_pd=importdata("y_shannon_i1_hc.txt","\n",5).data(male_pd_ind);
x_renyi2_i1_pd=importdata("x_renyi2_i1_hc.txt","\n",5).data(male_pd_ind);
y_renyi2_i1_pd=importdata("y_renyi2_i1_hc.txt","\n",5).data(male_pd_ind);
x_renyi3_i1_pd=importdata("x_renyi3_i1_hc.txt","\n",5).data(male_pd_ind);
y_renyi3_i1_pd=importdata("y_renyi3_i1_hc.txt","\n",5).data(male_pd_ind);
x_shannon_i2_pd=importdata("x_shannon_i2_hc.txt","\n",5).data(male_pd_ind);
y_shannon_i2_pd=importdata("y_shannon_i2_hc.txt","\n",5).data(male_pd_ind);
x_renyi2_i2_pd=importdata("x_renyi2_i2_hc.txt","\n",5).data(male_pd_ind);
y_renyi2_i2_pd=importdata("y_renyi2_i2_hc.txt","\n",5).data(male_pd_ind);
x_renyi3_i2_pd=importdata("x_renyi3_i2_hc.txt","\n",5).data(male_pd_ind);
y_renyi3_i2_pd=importdata("y_renyi3_i2_hc.txt","\n",5).data(male_pd_ind);
snr_ice_x_pd=importdata("snr_ice_x_hc.txt","\n",5).data(male_pd_ind);
snr_ice_y_pd=importdata("snr_ice_y_hc.txt","\n",5).data(male_pd_ind);
snr_itke1_x_pd=importdata("snr_itke1_x_hc.txt","\n",5).data(male_pd_ind);
snr_itke1_y_pd=importdata("snr_itke1_y_hc.txt","\n",5).data(male_pd_ind);
snr_itke2_x_pd=importdata("snr_itke2_x_hc.txt","\n",5).data(male_pd_ind);
snr_itke2_y_pd=importdata("snr_itke2_y_hc.txt","\n",5).data(male_pd_ind);
